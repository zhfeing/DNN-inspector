...
def main(args):
    ...
    val_dataset, _ = build_eval_dataset(data_cfg)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--feat-names", nargs="+", default=list())
    parser.add_argument("--attn-names", nargs="+", default=list())
    parser.add_argument("--feat-shape", nargs="+", type=int)
    parser.add_argument("--vis-img", action="store_true")
    parser.add_argument("--vis-feat", action="store_true")
    parser.add_argument("--vis-attn", action="store_true")
