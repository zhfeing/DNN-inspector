...
from general_kd.utils import DistLaunchArgs
...
def build_eval_dataloader(
    ...
    val_dataset, n_classes = build_eval_dataset(data_cfg)
...
def build_train_dataloader(
    ...
    train_dataset, val_dataset, n_classes = build_train_dataset(data_cfg)
